...
For the "name" field, provide the standard common English name for the compound (e.g. "water", "sodium chloride", "copper(II) hydroxide"). If a name is already provided and correct, use it.

Return ONLY this exact JSON structure with NO additional text:
{{
    "name": "standard common English name of the compound",
