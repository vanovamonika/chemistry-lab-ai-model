...
YOU MUST USE WEB SEARCH to find accurate visual descriptions. 
Return only the valid JSON structure with the visual description of the reaction specified above, without any additional text or explanations.
